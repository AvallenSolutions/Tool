...
export default function PioneersSubscriptionSimple() {
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/pioneers/create-subscription', {
        ...
        body: JSON.stringify({ 
          email, 
          captchaToken: 'development_bypass' // For development testing
        }),
      });
              ...
              <CardContent className="space-y-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-blue-900">Production Ready</h4>
                      <p className="text-sm text-blue-700 mt-1">
                        Full Stripe integration is configured. Deploy this application to enable secure payment processing.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <form onSubmit={handleEmailSubmit} className="space-y-6">
                  ...
                  >
                    ...
                    {isLoading ? "Creating Subscription..." : "Test Registration Flow"}
                  </Button>
                </form>
          ...
          {step === 'payment' && (
            <Card className="bg-white border shadow-xl">
              <CardHeader className="text-center space-y-4">
                ...
                <CardDescription className="text-lg">
                  Payment step - Ready for deployment
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-green-900">Stripe Integration Complete</h4>
                      <p className="text-sm text-green-700 mt-1">
                        Backend endpoints configured. Stripe Elements will work properly after deployment.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-amber-900">Deploy for Live Payments</h4>
                      <p className="text-sm text-amber-700 mt-1">
                        Click "Deploy" in Replit to enable secure Stripe payments with HTTPS.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-center justify-center">
                    ...
                    {isLoading ? "Processing..." : "Complete Test Registration"}
                  </div>
                </Button>
              </CardContent>
            </Card>
