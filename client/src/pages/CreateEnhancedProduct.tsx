...
export default function CreateEnhancedProduct() {
  ...
  const transformFormDataToDatabase = (data: any, isDraft: boolean = false) => {
    ...
    return {
      ...
      annualProductionVolume: data.production?.annualProductionVolume || data.annualProductionVolume,
      productionUnit: data.production?.productionUnit || data.productionUnit,
