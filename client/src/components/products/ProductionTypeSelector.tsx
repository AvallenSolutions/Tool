            ...
            <div className="space-y-4">
              {isComplete ? (
                <>
                  ...
                  {/* Production Impact Calculation Display */}
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4 space-y-3">
                    ...
                    <div className="border-t border-green-200 pt-3">
                      <p className="text-xs text-green-700">
                        <strong>Note:</strong> These values will be automatically added to your product's LCA calculations based on your actual facility data and annual production volume.
                      </p>
                    </div>
                  </div>
                </>
