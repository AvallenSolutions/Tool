...
- **Standards-Compliant Waste Footprint Calculation**: PHASE 1 & 2 COMPLETED - Replaced hardcoded 5% packaging waste factor with facility-based waste intensity allocation per GHG Protocol/ISO 14040 standards. Enhanced production_facilities table with comprehensive waste data collection fields (organic, packaging, hazardous, general waste by disposal route). Created regional_waste_statistics table for end-of-life calculations with UK baseline data. Implemented WasteIntensityCalculationService for facility waste allocation methodology. PHASE 1: Waste calculation reduced from 26.5g (5% packaging) to 3.8g (facility-based) per unit - 7x more accurate. PHASE 2: Added production waste carbon footprint calculation using disposal route emissions (0.000413 kg CO2e per unit) with DEFRA 2024 factors integrated into refined LCA endpoint. Cornwall distillery baseline: 3,795kg total facility waste/year across 1M units, disposal breakdown: 150kg landfill, 2,800kg recycling, 840kg composting.
